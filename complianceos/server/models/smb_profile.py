...
class SMBProfile(Base):
    ...
    gst_registered: Mapped[bool] = mapped_column(Boolean, default=False, server_default="false")
    gst_composition: Mapped[bool] = mapped_column(Boolean, default=False, server_default="false")
    has_factory: Mapped[bool] = mapped_column(Boolean, default=False, server_default="false")
    import_export: Mapped[bool] = mapped_column(Boolean, default=False, server_default="false")
    is_listed: Mapped[bool] = mapped_column(Boolean, default=False, server_default="false")
